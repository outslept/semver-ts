import type { SplitBy } from "../utils.js";
import type { ComparatorSet, PartialSemver, RangeNode } from "./ast.js";
import type { ParseComparator, ParsePartialSemver } from "./comparator.js";

type TrimLeft<S extends string> = S extends ` ${infer R}` ? TrimLeft<R> : S;
type TrimRight<S extends string> = S extends `${infer R} ` ? TrimRight<R> : S;
type Trim<S extends string> = TrimLeft<TrimRight<S>>;

type FilterEmpty<Ts extends string[], Acc extends string[] = []> = Ts extends [
